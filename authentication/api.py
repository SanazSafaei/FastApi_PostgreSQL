...
from authentication.utils import authentication_user,create_user,send_verfication_email,update_user_state
from authentication.security import create_access_token,get_password_hash,oauth2_scheme, validate_email,decode_token
...
async def active_user(access_token:str, rd: Redis = Depends(get_redis_database), db: AsyncIOMotorClient = Depends(get_database)):
